...
growth_hacking = Product.create(title: "Growth Hacking", 
 subtitle: "Crash Course", author: "Mattan Griffel", length: "30 minutes", author_image_name: "teacher-image.jpg", details: "You'll get one video",
 price: "4.99", download_url: "https://s3.amazonaws.com/omstripesilo/marketing1.pdf",sku: "GROHACK1", description: %{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
